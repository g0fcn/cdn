...
function erphpdown_install() {
	...
	$update19="ALTER TABLE `".$wpdb->icemoney."` ADD `ice_note_other` varchar(200)";
	$wpdb->query($update19);

	$update19="ALTER TABLE `".$wpdb->icemoney."` ADD INDEX(`ice_num`);";
	$wpdb->query($update19);

	$update20="ALTER TABLE `".$wpdb->icealipay."` ADD INDEX(`ice_user_id`);";
	$wpdb->query($update20);

	$update20="ALTER TABLE `".$wpdb->icealipay."` ADD INDEX(`ice_post`);";
	$wpdb->query($update20);

	$update20="ALTER TABLE `".$wpdb->checkin."` ADD INDEX(`user_id`);";
	$wpdb->query($update20);
