...
class WPJAM_Basic extends WPJAM_Option_Model{
	...
	public static function filter_url($url){
		...
		if($object && $object->url){
			return str_replace(WPJAM_Gravatar::get_search(), $object->url, $url);
		}
	...
	public static function filter_html($html){
		...
		if($object){
			$search	= preg_filter('/^/', '//', array_values(WPJAM_Google_Font::get_domains()));
	...
	public static function add_hooks(){
		...
		add_filter('get_avatar_url',	[self::class, 'filter_url']);
