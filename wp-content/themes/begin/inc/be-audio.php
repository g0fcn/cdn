...
class BeAudioIgniter {
	...
	public function register_taxonomies() {
		$labels = array(
			...
			'search_items'      => esc_html__( '搜索音频分类', 'begin' ),
			'all_items'         => esc_html__( '全部音频分类', 'begin' ),
			...
			'add_new_item'      => esc_html__( '添加新分类', 'begin' ),
			'new_item_name'     => esc_html__( '新分类名称', 'begin' ),
	...
	public function register_scripts() {
		wp_register_style( 'be_audio', get_template_directory_uri() . '/css/player.css', array(), version );
		wp_register_script( 'be_audio', get_template_directory_uri() . '/js/player.js', array(), version, true );

		wp_localize_script( 'be_audio', 'aiStrings', apply_filters( 'audioigniter_aiStrings', array(
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'be_audio' );
		wp_enqueue_style( 'grey' );
		wp_enqueue_script( 'be_audio' );
	}
...
//		}
	...
	public function filter_posts_columns( $columns ) {
		...
		$columns['shortcode'] = __( '短代码', 'begin' );
		$columns['date']      = $date;
