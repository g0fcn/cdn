...
* 新增函数：array_move / wpjam_get_all_terms / wpjam_html_tag_processor / wpjam_dashboard_widget
...
* 新增函数 wpjam_date / wpjam_strtotime 用于日期处理。
...
* 新增函数 wpjam_register_extend_option / wpjam_load_extends
